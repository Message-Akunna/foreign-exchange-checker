      ...
      <>
        ...
        >
          <div id={triggerDescriptionId} className="sr-only">
            Multi-select dropdown. Use arrow keys to navigate, Enter to select, and Escape
            to close.
          </div>
          ...
          <PopoverTrigger
            render={
              <Button
                ...
                className={cn(
                  'flex p-1 rounded-md border border-input min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit dark:bg-input/30 [&_svg]:pointer-events-auto',
              ...
              <div className="flex justify-between items-center w-full">
                      ...
                      return (
                        <Badge
                          ...
                          className={cn(
                            ...
                            responsiveSettings.compactMode && 'text-xs px-1.5 py-1',
                        ...
                        >
                          {IconComponent && !responsiveSettings.hideIcons && (
                            <IconComponent
                              className={cn(
                                'size-4 mr-2',
                                responsiveSettings.compactMode && 'size-3 mr-1',
                          ...
                          <div
                            ...
                            className="ml-2 size-4 cursor-pointer hover:bg-white/20 rounded-sm p-0.5 -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50"
                          >
                            <XIcon
                              className={cn(
                                'size-3',
                ...
                <div className="flex items-center justify-between">
                  <div
                    ...
                    className="flex items-center justify-center size-4 mx-2 cursor-pointer text-muted-foreground hover:text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1 rounded-sm"
                  >
